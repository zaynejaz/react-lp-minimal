...
const VideoOne = () => {
  ...
  return (
    <Box as="section" sx={styles.video}>
      <Container>
        <Heading as="h3">
          Send better invoices...<br/> Get paid faster!
        </Heading>
        <Text as="p">
          Create custom, professional invoices in a few easy steps that convert from sent to paid, in just a few days. 
        </Text>
        <Link path="/" sx={styles.link}>
          Disover How <FaAngleRight />
        </Link>
