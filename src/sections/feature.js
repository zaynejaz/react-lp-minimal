...
const FeatureData = [
  ...
  {
    image: featureImage2,
    title: 'Advantages of using Minimal to make timekeeping more efficient',
  ...
  },
  {
    image: featureImage3,
    title:
      'Make tax time smoother with automations for Minimal',
...
const Feature = () => {
  ...
  return (
    <Box sx={styles.features} id="news">
      <Container>
        <BlockTitle
          slogan="The Minimal Blog"
          title="Powering Your Prosperity – One Post at a Time"
